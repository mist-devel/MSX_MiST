Collect the firmware using the scripts
======================================
...
2.  Run '2_compile.cmd' and go with 'Start Compilation' of Quartus II.
    ...
    By jumping the conversion you obtain a PLD firmware without the MSX BIOS:
    the machine will run using the SD-BIOS only, useful for manufacturers.

3.  Get out from Quartus II and run '3_finalize.cmd'.

4.  If you want collect a single firmware proceed with '4_collect.cmd'.
    To create the second firmware type you can repeat
    the points 1, 2, 3, 1 again and finally proceed with '4_collect.cmd'.
    The firmwares are stored inside the 'fw\' subfolder.
...
'0_readme.txt' v2.3 by KdL (2018.07.27)
