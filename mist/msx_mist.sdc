...
set_output_delay -clock [get_clocks {pll|altpll_component|auto_generated|pll1|clk[2]}] -max 1.5 [get_ports {SDRAM_CLK}]
set_output_delay -clock [get_clocks {pll|altpll_component|auto_generated|pll1|clk[2]}] -min -0.8 [get_ports {SDRAM_CLK}]
